...
export const mockKeycloakService = {
    ...
    getUser: vi.fn().mockImplementation(async (userId) => {
...
export function resetKeycloakMock() {
    ...
    mockKeycloakService.registerUser.mockImplementation(async (credentials) => {
        return `keycloak-${credentials.username}-${Date.now()}`;
    });
    ...
    mockKeycloakService.getUser.mockImplementation(async (userId) => {
        return {
            id: userId,
            username: 'testuser',
            email: 'test@example.com',
 ...
 */
export function mockDuplicateUserError() {
 ...
 */
export function mockDuplicateUpdateError() {
 ...
 */
export function mockRoleNotFoundError() {
 ...
 */
export function mockUserNotFoundError() {
    mockKeycloakService.getUser.mockResolvedValue(null);
}
//# sourceMappingURL=keycloak-mock.js.map