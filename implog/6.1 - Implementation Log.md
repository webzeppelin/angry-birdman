...
### 4.1 Battle API Routes (Task 4 - In Progress)

**File To Create**: `api/src/routes/battles.ts`
...
### 4.2 Battle Service Layer (Task 5 - Planned)

**File To Create**: `api/src/services/battle.service.ts`
...
**API** (0 files created yet):

- (Planned) `api/src/routes/battles.ts`
- (Planned) `api/src/services/battle.service.ts`
...
- 🟡 Task 4: Battle API routes (next)
- 🟡 Task 17: This implementation log

**Not Started**:

- ⬜ Tasks 5-16: API service, frontend components, testing
