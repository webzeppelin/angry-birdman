        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div>
            ...
            <input
              ...
              } focus:border-primary focus:ring-primary rounded-md placeholder-gray-400 shadow-sm focus:outline-none sm:text-sm`}
          ...
          <div>
            <button
              ...
              className="hover:bg-primary-dark group bg-primary focus:ring-primary relative flex w-full justify-center rounded-md border border-transparent px-4 py-2 text-sm font-medium text-white focus:ring-2 focus:ring-offset-2 focus:outline-none disabled:cursor-not-allowed disabled:opacity-50"
            >
