      ...
      <div className="w-full max-w-2xl space-y-8">
        ...
        <div className="mt-8">
          ...
          <div className="grid gap-6 md:grid-cols-2">
            ...
            <Link
              to="/register/clan"
              className="hover:border-primary focus:ring-primary relative rounded-lg border border-gray-300 bg-white p-6 shadow-sm transition-all duration-200 hover:shadow-md focus:ring-2 focus:ring-offset-2 focus:outline-none"
            >
