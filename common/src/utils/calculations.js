 ...
 */
export function calculateBattleResult(score, opponentScore) {
 ...
 */
export function calculateClanRatio(score, baselineFp) {
    if (baselineFp === 0) {
 ...
 */
export function calculateAverageRatio(score, fp) {
    if (fp === 0) {
 ...
 */
export function calculatePlayerRatio(score, fp) {
    if (fp === 0) {
        throw new Error('fp cannot be zero');
    }
    return (score / fp) * RATIO_MULTIPLIER;
 ...
 */
export function calculateProjectedScore(score, nonplayingFpRatio) {
 ...
 */
export function calculateMarginRatio(score, opponentScore) {
    if (score === 0) {
 ...
 */
export function calculateFpMargin(baselineFp, opponentFp) {
    if (baselineFp === 0) {
        throw new Error('baselineFp cannot be zero');
    }
 ...
 */
export function calculateNonplayingFpRatio(nonplayingFp, fp) {
    if (fp === 0) {
 ...
 */
export function calculateReserveFpRatio(reserveFp, fp) {
 ...
 */
export function calculateRatioRanks(playerRatios) {
    ...
    // Assign ranks
    const ranks = new Array(playerRatios.length);
 ...
 */
export function calculatePlayerRatioRanks(playerStats) {
    // Calculate ratios
 ...
 */
export function calculateTotalFp(playerStats, nonplayerStats) {
 ...
 */
export function calculateNonplayingCount(nonplayerStats) {
 ...
 */
export function calculateReserveCount(nonplayerStats) {
    return nonplayerStats.filter((np) => np.reserve).length;
}
/**
 ...
 */
export function calculateNonplayingFp(nonplayerStats) {
 ...
 */
export function calculateReserveFp(nonplayerStats) {
    return calculateSum(nonplayerStats.filter((np) => np.reserve).map((np) => np.fp));
}
// ============================================================================
 ...
 */
export function calculateCount(values, predicate) {
