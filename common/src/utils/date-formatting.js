 ...
 */
export function generateBattleId(date) {
 ...
 */
export function generateMonthId(date) {
    const year = date.getFullYear();
    const month = String(date.getMonth() + 1).padStart(2, '0');
    return `${year}${month}`;
}
 ...
 */
export function generateYearId(date) {
 ...
 */
export function parseBattleId(battleId) {
    if (battleId.length !== BATTLE_ID_LENGTH) {
        throw new Error(`Invalid battle ID length: expected ${BATTLE_ID_LENGTH}, got ${battleId.length}`);
    }
 ...
 */
export function parseYearId(yearId) {
 ...
 */
export function validateBattleId(battleId) {
    try {
 ...
 * @returns true if valid
 */
export function validateMonthId(monthId) {
    try {
 ...
 * @returns true if valid
 */
export function validateYearId(yearId) {
    try {
        parseYearId(yearId);
        return true;
    }
 ...
 */
export function getBattleIdsForMonth(monthId) {
 ...
 */
export function getMonthIdsForYear(yearId) {
    const year = parseInt(yearId, 10);
    const monthIds = [];
 ...
 */
export function getMonthIdFromBattleId(battleId) {
    if (battleId.length !== BATTLE_ID_LENGTH) {
 ...
 */
export function getYearIdFromBattleId(battleId) {
    if (battleId.length !== BATTLE_ID_LENGTH) {
        throw new Error(`Invalid battle ID: ${battleId}`);
    }
 ...
 * @returns Year ID (YYYY)
 */
export function getYearIdFromMonthId(monthId) {
    if (monthId.length !== MONTH_ID_LENGTH) {
 ...
 */
export function formatMonthDisplay(monthId, locale = 'en-US') {
    const date = parseMonthId(monthId);
 ...
 * @returns Formatted date string
 */
export function formatBattleDisplay(battleId, locale = 'en-US') {
