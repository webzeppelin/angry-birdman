 ...
 */
export function toOfficialAngryBirdsTime(date) {
    // Get UTC timestamp
    ...
    return new Date(Date.UTC(estDate.getUTCFullYear(), estDate.getUTCMonth(), estDate.getUTCDate(), estDate.getUTCHours(), estDate.getUTCMinutes(), estDate.getUTCSeconds(), estDate.getUTCMilliseconds()));
}
/**
 ...
 */
export function estToGmt(estDate) {
 ...
 */
export function gmtToEst(gmtDate) {
 ...
 */
export function getCurrentAngryBirdsTime() {
 ...
 */
export function createEstDate(year, month, day, hour = 0, minute = 0, second = 0) {
 ...
 */
export function formatForUserTimezone(date, timezoneOrOptions, optionsParam) {
 ...
 */
export function getBattleStartTimestamp(date) {
 ...
 */
export function getBattleEndTimestamp(startDate) {
    ...
    // Set to 23:59:59
    return createEstDate(tempDate.getFullYear(), tempDate.getMonth() + 1, tempDate.getDate(), 23, 59, 59);
}
/**
 ...
 */
export function formatBattleDate(date) {
    const dateObj = typeof date === 'string' ? new Date(date) : date;
