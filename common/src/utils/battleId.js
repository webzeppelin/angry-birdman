 ...
 * ```
 */
export function generateBattleIdFromEst(estDate) {
 ...
 */
export function parseBattleIdComponents(battleId) {
 ...
 * @throws Error if battleId format is invalid
 */
export function getNextBattleId(battleId) {
    const date = parseBattleId(battleId);
 ...
 * @throws Error if battleId format is invalid
 */
export function getPreviousBattleId(battleId) {
    const date = parseBattleId(battleId);
    // Subtract 3 days
    date.setDate(date.getDate() - 3);
    // Re-generate battle ID from new date (uses local timezone components)
 ...
 * @throws Error if battleId format is invalid
 */
export function battleIdToDate(battleId) {
 ...
 */
export function compareBattleIds(battleId1, battleId2) {
 ...
 */
export function sortBattleIdsAscending(battleIds) {
 ...
 * @returns Sorted array of battle IDs
 */
export function sortBattleIdsDescending(battleIds) {
    return [...battleIds].sort((a, b) => compareBattleIds(b, a));
}
//# sourceMappingURL=battleId.js.map