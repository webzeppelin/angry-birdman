...
################################################################################
# backup-db.sh - Create a backup of the Angry Birdman database
#
# This script creates a timestamped backup of the PostgreSQL database using
# pg_dump. Backups are stored in the backups/ directory with both SQL and
# compressed formats.
#
...
echo -e "${BLUE}╔════════════════════════════════════════════════════════╗${NC}"
echo -e "${BLUE}║       Angry Birdman Database Backup Utility           ║${NC}"
echo -e "${BLUE}╚════════════════════════════════════════════════════════╝${NC}"
echo
...
echo -e "  ./scripts/restore-db.sh ${BACKUP_PATH}"
echo
